...
ConsolePanel.prototype =
{
    ...
    log: function()
    {
 			this.append(appendFormatted, arguments, "log");
    },
    warn: function()
    {
 			this.append(appendFormatted, arguments, "warn");
    },
    info: function()
    {
 			this.append(appendFormatted, arguments, "info");
    },
    ...
    append: function(appender, objects, className, rep, sourceLink, noRow)
    {
        ...
        {
            var scrolledToBottom = FirebugLib.isScrolledToBottom(this.panelNode);
            ...
            if (scrolledToBottom)
                FirebugLib.scrollToBottom(this.panelNode);
    ...
    hide: function()
    {
        this.wasScrolledToBottom = FirebugLib.isScrolledToBottom(this.panelNode);
    },
